...
#Realizar la division entre el resultado de la resta y el resultado de la suma 
print("Se hara una division entre el resultado de la suma y el resultado de la resta.")
